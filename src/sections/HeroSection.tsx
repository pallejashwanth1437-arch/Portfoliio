...
export const HeroSection: React.FC<HeroSectionProps> = ({ onProjectsClick, onContactClick }) => {
  return (
    <section className="min-h-screen w-full flex flex-col justify-center overflow-x-clip relative bg-waves py-16 md:py-20 px-6 sm:px-12 md:px-16 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 items-center z-10">
        ...
        <div className="col-span-1 md:col-span-7 flex flex-col items-start text-left gap-5 md:gap-8 order-2 md:order-1 pl-4 sm:pl-8 md:pl-10 lg:pl-16">
