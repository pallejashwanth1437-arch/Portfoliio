...
export const HeroSection: React.FC<HeroSectionProps> = ({ onProjectsClick, onContactClick }) => {
  return (
    <section className="min-h-screen w-full flex flex-col justify-center overflow-x-clip relative bg-waves py-16 md:py-20" style={{ paddingLeft: 'clamp(3rem, 10vw, 10rem)', paddingRight: 'clamp(1rem, 5vw, 4rem)' }}>
