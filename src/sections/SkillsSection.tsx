...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section id="skills" className="min-h-screen w-full bg-waves flex flex-col items-center justify-center py-20 px-5 sm:px-8 md:px-10 relative z-30 overflow-hidden">
