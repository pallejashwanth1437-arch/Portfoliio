...
export const CertificationsSection: React.FC = () => {
  return (
    <section id="certifications" className="min-h-screen w-full bg-[#0C0C0C] flex flex-col items-center justify-center py-20 px-5 sm:px-8 md:px-10 border-t border-white/5 relative z-30">
