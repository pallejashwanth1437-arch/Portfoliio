...
export const EducationSection: React.FC = () => {
  return (
    <section
      id="education"
      className="min-h-screen w-full bg-[#0C0C0C] text-[#D7E2EA] px-5 sm:px-8 md:px-10 py-20 relative z-20 flex flex-col items-center justify-center border-t border-white/5"
    >
